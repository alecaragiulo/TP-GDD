...
INSERT INTO Caracteristica(descripcion)
	...
	INSERT INTO inmueble(codigo,tipo_inmueble_id,descripcion,propietario_id,direccion,barrio_id,ambiente_id,
...
select provincia_id , count (distinct nombre)
FROM localidad
...
select count(distinct INMUEBLE_LOCALIDAD)
from gd_esquema.Maestra
where INMUEBLE_PROVINCIA = 'Chaco'
